        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ExerciseDuration = table.Column<int>(type: "INTEGER", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_DailyEntries_Profiles_ProfileId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ExerciseLogs_DailyEntries_DailyEntryId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_DailyEntries_ProfileId_Date",
                table: "DailyEntries",
                columns: new[] { "ProfileId", "Date" },
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_ExerciseLogs_DailyEntryId",
                table: "ExerciseLogs",
                column: "DailyEntryId");
